const CACHE = "prem-oracle-v1-20260709h";
const ASSETS = ["./", "index.html", "reset-cache.html", "styles.css?v=20260709h", "app.js?v=20260709h", "data/fixtures.json", "icon.svg", "icons/icon-192.png", "icons/icon-512.png", "icons/apple-touch-icon.png", "manifest.webmanifest"];
